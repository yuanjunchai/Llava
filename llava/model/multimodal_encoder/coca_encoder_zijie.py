...
class COCAVisionTower(nn.Module):
    ...
    def load_model(self, device_map="auto"):
        ...
        vision_tower, _, image_processor = open_clip.create_model_and_transforms(
            ...
            pretrained='/root/.cache/huggingface/hub/models--laion--CoCa-ViT-L-14-laion2B-s13B-b90k/snapshots/74207cb7fde8eafc9864451ebd332fa8e75b150f/open_clip_pytorch_model.bin',
            precision="fp32",
            device="cuda",
