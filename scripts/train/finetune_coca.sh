...
BASE_RUN_NAME="demo_llavanext-ddp-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain"
...
# Stage 2
PROMPT_VERSION=v1
RUN_NAME="demo_LoRA-ft-llava-next-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-stage2-${timestamp}" 
...
ACCELERATE_CPU_AFFINITY=1 torchrun --master_port=${PORT} llava/train/train_mem.py \
