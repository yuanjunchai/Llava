...
class OpenCLIPVisionTower(nn.Module):
    def __init__(self, vision_tower_ori_name, args, delay_load=False):
        ...
        self.pretrained = "laion2b_s32b_b82k" # coca: "laion2b_s13b_b90k"
    ...
    def forward(self, images):
        ...
        if type(images) is list:
            ...
            image_features = self.feature_select(image_forward_outs).to(images.dtype) #[1]
